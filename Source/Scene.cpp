...
void Scene::CreateCircleGeometry()
{
    const uint32_t k_PointCount = 10;

    std::vector<XMFLOAT2> vertices{ k_PointCount };
    XMFLOAT2* ptr = vertices.data();

    for (uint32_t i = 0; i < k_PointCount; ++i)
    {
        /*
